...
using ReportPortalApiSteps = ReportPortal.E2E.API.Framework.StepDefinitions.ReportPortalApiSteps;

namespace ReportPortal.E2E.API.Framework
{
    public class Steps
    {
        ...
        private static ILogger Log = TestsLogger.Create<Steps>();//todo
